            ...
            <view v-if="isPopupShare">
              <view class="popupShareView">
                <view class="uni-share-content-box">
                  <view class="uni-share-content-item" v-for="(item,index) in shareList" :key="index">
                    <view class="iconfont" :class="item.icon"></view>
                    <button plain class="wx" open-type='share'>{{item.text}}</button>
<!--                    <text class="uni-share-text">{{item.text}}</text>-->
      ...
      <view class="wx-share" @click="openShare">
...
export default {
  ...
  methods: {
    ...
    //     imageUrl: this.img_list[0].img_src,
    //     success: () => {
...
.wx-share{
  ...
  background-color: rgba(253, 118, 0, 0.1);
  border-radius: 23px;
  position: absolute;
  top:150rpx;
  right: 30rpx;
...
@font-face {
  ...
  src: url('//at.alicdn.com/t/font_2787414_mhrnfrsgbd.woff2?t=1632465716274') format('woff2'),
  url('//at.alicdn.com/t/font_2787414_mhrnfrsgbd.woff?t=1632465716274') format('woff'),
  url('//at.alicdn.com/t/font_2787414_mhrnfrsgbd.ttf?t=1632465716274') format('truetype');
}
