    ...
    <swiper class="swiper" :current="index" @change="change">
      <swiper-item v-for="(img, i) in imgs" :key="i">
        <movable-area class="marea" scale-area>
          <movable-view class="mview" direction="all" scale="true" @scale="onScale" scale-min="0.5" scale-max="4"
                        :scale-value="scale">
            <image class="image" :src="img" :data-index="i" :data-src="img" mode="widthFix" @touchmove="handletouchmove"
